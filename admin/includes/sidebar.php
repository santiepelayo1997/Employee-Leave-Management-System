     <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
                    ...
                    <li class="no-padding">
                        <a class="collapsible-header waves-effect waves-grey"><i class="material-icons">perm_identity</i>Position<i class="nav-drop-icon material-icons">keyboard_arrow_right</i></a>
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="addposition.php">Add Position</a></li>
                                <li><a href="manageposition.php">Manage Position</a></li>
    ...
    <li class="no-padding"><a class="waves-effect waves-grey" href="leaves.php"><i class="material-icons">desktop_windows</i>Leave Management</a></li>
                               <li class="no-padding"><a class="waves-effect waves-grey" href="manageseminar.php"><i class="material-icons">date_range</i>Manage Seminars</a></li>

        <li class="no-padding">
                        <a class="collapsible-header waves-effect waves-grey"><i class="material-icons">chrome_reader_mode</i>Leave Credit Logs<i class="nav-drop-icon material-icons">keyboard_arrow_right</i></a>
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="manageleavelogs.php">All Leave Credit Logs</a></li>
                            </ul>
                        </div>
                    </li>
                   ...
                   <div class="footer">
                    <p class="copyright">EMS <a href="">2018-2019</a>©</p>
