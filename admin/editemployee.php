...
<div class="input-field col m6 s12">
<input id="birthdate" name="dob" class="datepicker" data-inputmask="'alias': 'date'" value="<?php echo htmlentities($result->Dob);?>" >
</div>
...
<option value="<?php echo htmlentities($result->Positions);?>"><?php echo htmlentities($result->Positions);?></option>
...
foreach($results as $resultt)
{   ?>                                            
<option value="<?php echo htmlentities($resultt->pos_name);?>"><?php echo htmlentities($resultt->pos_name);?></option>
<?php }} ?>
</select>
 </div>
...
<input id="leavedays" name="sickleave" type="text"  maxlength="4" min="0"  value="<?php echo htmlentities($result->sickleave);?>" autocomplete="off" required>
</div>

   
<div class="input-field col m6 s12">
<label for="leavedays">Vacation Leave</label>
<input id="leavedays" name="vacationleave" type="text"  maxlength="4" min="0"  value="<?php echo htmlentities($result->vacationleave);?>" autocomplete="off" required>
</div>

<div class="input-field col m6 s12">
<label for="leavedays">Special Leave</label>
<input id="leavedays" name="specialleave" type="text"  maxlength="4" min="0"  value="<?php echo htmlentities($result->specialleave);?>" autocomplete="off" required>
</div>
...
<input id="leavedays" name="leavedays" type="text"  maxlength="4" min="0"  value="<?php echo htmlentities($result->total);?>" autocomplete="off" required readonly>
</div>
