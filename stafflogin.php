...
$sql ="SELECT EmailId,Password,Status,id,Positions FROM tblemployees WHERE EmailId=:uname and Password=:password and Positions='Office Staff'";
        ...
        <div class="mn-content fixed-sidebar">
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion" style="">
                    <li>&nbsp;</li>
                    <li class="no-padding"><a class="waves-effect waves-grey" href="#"><i class="material-icons">account_box</i>Staff Login</a></li>
