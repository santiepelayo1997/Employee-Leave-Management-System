                                       ...
                                       <div class="row">
                                           <form class="col s12" name="signin" method="post">
                                               ...
                                               <div class="col s12 right-align m-t-sm">
                                                   ...
                                                   <input type="submit" name="submit" value="Sign in" class="waves-effect waves-light btn green">
                                               </div>
                                           </form>
                                      </div>
                                  </div>
...
<div class="input-field col s12">
<button type="submit" name="change" class="waves-effect waves-light btn green m-b-xs" onclick="return valid();">Change</button>
