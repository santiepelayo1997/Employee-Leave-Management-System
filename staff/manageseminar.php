...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Staff | Manage Seminar</title>
                                            ...
                                            <td><?php echo htmlentities($result->todate);?></td>
                                             <td><?php echo htmlentities($result->hours);?></td>
                                               ...
                                               <td><?php echo htmlentities($result->created_date);?></td>
                                                    <td><a href="manageseminar.php?del=<?php echo htmlentities($result->seminar_id);?>" onclick="return confirm('Do you want to delete');"> <i class="material-icons">delete_forever</i></a></td>
                                        </tr>
                                         <?php $cnt++;} }?>
                                    </tbody>
                                </table>
